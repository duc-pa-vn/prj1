            ...
            <div class="col-md-9">
                <div class="panel panel-default">            
                    <div class="panel-heading" style="background-color:#337AB7; color:white;" >
                        <h2 style="margin-top:0px; margin-bottom:0px;">Bundes Liga</h2>
                    </div>
                        <ul class="nav-bar list-inline" style="margin-top:5px; margin-left:5px">
                            <li><a href="page/BundesLiga/clb">Câu lạc bộ<a></li>
                            <li><a href="page/BundesLiga/bxh">Bảng xếp hạng</a></li>
                            <li><a href="page/BundesLiga/lich" style="color: #d0060c">Lịch thi đấu</a></li>
                        </ul>
